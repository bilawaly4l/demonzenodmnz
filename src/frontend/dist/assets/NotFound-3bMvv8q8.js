import { c as createLucideIcon, j as jsxRuntimeExports, Z as Zap, B as Button, L as Link } from "./index-DgNuRIli.js";
/**
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 flex flex-col items-center gap-8 text-center max-w-xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-primary/10 rounded-full blur-3xl scale-75 animate-pulse-glow pointer-events-none" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 w-full sm:w-auto", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", children: "View Signals" })
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs max-w-sm", children: "If you think this is a mistake, check the URL or head back to the homepage and navigate from there." })
      ] })
    }
  );
}
