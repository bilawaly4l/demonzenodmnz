    ...
    "div",
    {
      ...
      children: [
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-16", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "scroll-anim", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "label-uppercase text-crimson", children: "Read Before Buying" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "heading-xl mt-2 mb-5", children: "RISK DISCLOSURE" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    className: "text-lg max-w-2xl leading-relaxed",
                    style: { color: "var(--muted-foreground)" },
                    children: "Meme coins are volatile. Here is everything you need to know before buying DMNZ — including the worst case scenarios."
                  }
                )
              ] })
            ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-16 max-w-3xl", children: [
            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
                  ...
                  style: { color: "var(--muted-foreground)" },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "var(--primary)" }, children: "THE ONLY RULE:" }),
                    " ",
                    "Never invest more than you are completely comfortable losing. DMNZ is entertainment with financial components. Treat it as such."
                  ]
                }
              )
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-4", children: RISKS.map((risk, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "scroll-anim mt-10", style: { transitionDelay: "400ms" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: "text-xs font-mono text-center",
              style: { color: "#555555" },
              children: "This disclosure is provided for informational purposes only and does not constitute financial or legal advice."
            }
          ) })
        ] })
      ]
